...
yeccpars2_3(S, bind, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_5(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_toplevel(hd(Nss), Cat, Nss, NewStack, T, Ts, Tzr).
...
yeccgoto_toplevels(0, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_1(1, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_toplevels(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_9(_S, Cat, Ss, Stack, T, Ts, Tzr).

-compile({inline,yeccpars2_2_/1}).
-file("src/riot_parser.yrl", 2).
